...
#include "base/ipc/ipc_message_start.h"
#include "base/ipc/ipc_param_traits.h"
...
struct ParamTraits<bool> {
  ...
  BASE_EXPORT static void Log(const param_type& p, std::string* l);
};
...
template <>
struct BASE_EXPORT ParamTraits<unsigned short> {
...
// IPC.
template <>
struct BASE_EXPORT ParamTraits<float> {
...
template <>
struct BASE_EXPORT ParamTraits<double> {
...
template <>
struct BASE_EXPORT ParamTraits<std::vector<char> > {
...
template <>
struct BASE_EXPORT ParamTraits<std::vector<unsigned char> > {
...
template <>
struct BASE_EXPORT ParamTraits<std::vector<bool> > {
...
template <>
struct BASE_EXPORT ParamTraits<base::DictionaryValue> {
...
template<>
struct BASE_EXPORT ParamTraits<base::FileDescriptor> {
...
template <>
struct BASE_EXPORT ParamTraits<FilePath> {
...
template <>
struct BASE_EXPORT ParamTraits<base::ListValue> {
...
template <>
struct BASE_EXPORT ParamTraits<NullableString16> {
...
template <>
struct BASE_EXPORT ParamTraits<base::PlatformFileInfo> {
...
template <>
struct BASE_EXPORT ParamTraits<base::Time> {
...
template <>
struct BASE_EXPORT ParamTraits<base::TimeDelta> {
...
template <>
struct BASE_EXPORT ParamTraits<base::TimeTicks> {
...
template<>
struct BASE_EXPORT ParamTraits<IPC::ChannelHandle> {
...
template <>
struct BASE_EXPORT ParamTraits<LogData> {
...
template <>
struct BASE_EXPORT ParamTraits<Message> {
...
#if defined(OS_WIN)
template <>
struct BASE_EXPORT ParamTraits<HANDLE> {
...
template <>
struct BASE_EXPORT ParamTraits<LOGFONT> {
...
template <>
struct BASE_EXPORT ParamTraits<MSG> {
...
BASE_EXPORT void GenerateLogData(const std::string& channel,
